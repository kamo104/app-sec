  ...
  <v-container class="py-8 fill-height" fluid>
    <v-row align="center" class="fill-height" justify="center">
      <v-col cols="12" lg="5" md="6">
        <AuthFormLayout ref="authFormLayout" title="Register">
...
<script setup lang="ts">
  ...
  import { type RegisterErrorResponse, registerUser } from '@/api/client'
  ...
  function handlePasswordValidation (isValid: boolean, errors: string[]): void {
  ...
  function handleRegistrationError (error: RegisterErrorResponse, status: number): void {
    console.error('Registration error:', error)
