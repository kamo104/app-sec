...
This section documents the registration and email verification endpoints. Types are defined in the \texttt{api-types} crate and shared between backend and frontend.
...
Types are defined in \texttt{api-types/src/}:
