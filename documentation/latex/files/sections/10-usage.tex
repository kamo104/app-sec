...
\begin{verbatim}
# Start MailHog for email testing (in separate terminal)
mailhog
...
\begin{itemize}[leftmargin=*,nosep]
  ...
  \item Base URL for verification links uses \texttt{BASE\_URL\_DEV}.
\end{itemize}
...
\begin{itemize}[leftmargin=*,nosep]
  ...
  \item \texttt{@hey-api/client-fetch} -- API client generation
