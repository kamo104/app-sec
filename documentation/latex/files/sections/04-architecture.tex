...
\begin{itemize}[leftmargin=*,nosep]
  ...
  \item WASM modules for validation and translation (shared with backend)
\end{itemize}
...
\begin{itemize}[leftmargin=*,nosep]
  ...
  \item \texttt{api-types}: Request/response type definitions
  \item \texttt{field-validator}: Input validation logic (compiled to native and WASM)
  \item \texttt{translator}: Error message translation
\end{itemize}
...
\begin{itemize}[leftmargin=*,nosep]
  ...
  \item SQLite with SQLCipher encryption
  \item Foreign keys with CASCADE delete
\end{itemize}
